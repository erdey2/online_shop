...
urlpatterns = [
    ...
    path('availability/<uuid:product_id>/', ProductAvailabilityView.as_view(), name='product-availability'),
    path('price-history/<uuid:product_id>/', PriceHistoryView.as_view(), name='price-history')
